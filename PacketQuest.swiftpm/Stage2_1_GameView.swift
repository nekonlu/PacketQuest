...
struct Stage2_1_GameView: View {
    ...
    @State private var isShowingL3Router1Properties: Bool = false
    @State private var isShowingL3Router2Properties: Bool = false
    ...
    var body: some View {
        GeometryReader { proxy in
            ...
            .position(x: width / 2.5 - 100, y: height / 2)
            .onTapGesture {
                isShowingL3Router1Properties = true
            }
            ...
            .position(x: width / 1.3 - 100, y: height / 2)
            .onTapGesture {
                isShowingL3Router2Properties = true
            }
                ...
                HStack {
                    Button {
                        if viewmodel.computer.routingTable.table[0].destinationNetwork.displayIP() == "10.0.0.0/8" &&
                            ...
                            packetPosition = CGPoint(x: width - 300, y: height / 2)
                            print("success")
                        } else {
                            isResultAlert = true
                            isSuccess = false
        ...
        .sheet(isPresented: $isShowingL3Router1Properties, content: {
            NavigationStack {
                List {
